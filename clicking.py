...
def buttonClicked(raw, c_f, top_loc, next_loc_dic, loc_2, loc_3, loc_4, loc_5, level, Top, title):
    if level > 4:
    ...
    App = application.App(raw, c_f, top_dic, next_loc_dic, loc_2, loc_3, loc_4, loc_5, level, Top, title)
    App.exec_()